...
def crawl(
    start_date: date = date(2024, 5, 2),
    end_date: date = date.today() - timedelta(2),
    name: str = "en_citynomads"
):

    settings = get_project_settings()
    # settings.set('LOG_FILE', "./log/{}_debug.log".format(name))
    settings.set('LOG_FILE', "./log/2024-05-04_2024-05-11.log".format(name))
