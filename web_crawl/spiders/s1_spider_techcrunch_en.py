...
class TechCrunchSpider(scrapy.Spider):
    ...
    base_url = 'https://techcrunch.com/wp-json/tc/v1/magazine?page='
    page = 1
    ...
    def parse_article(self, response):
        ...
        texts = response.xpath('//div[@class="article-content"]/p')
        for text in texts:
            if text.xpath('.//img'):
                continue
...
def main(output_path='techcrunch_en.jl', start_date=(date.today() - timedelta(1)), end_date=date.today()):
    ...
    process.crawl(TechCrunchSpider, start_date=start_date, end_date=end_date)
