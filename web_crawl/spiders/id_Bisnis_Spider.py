...
class id_Bisnis_Spider(scrapy.Spider):
    ...
    def __init__(self, start_date, end_date):
        ...
        while self.start_time < self.end_time:
            self.start_urls.append(r'https://www.bisnis.com/index?c=0&d=' + str(self.start_time.date()))
    ...
    def parse(self, response):
        ...
        for article in articles:
            date_time_str = article.xpath('./div[2]/div/div/div[@class="date"]/text()').get().split('|')[0].strip()
...
def main():
    ...
    d = runner.crawl(id_Bisnis_Spider,
